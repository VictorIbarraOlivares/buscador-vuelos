...
const Index = () => {
  ...
  const {
    saveItem: saveParamsSearchFlight
  ...
  useEffect(() => {
    ...
    getTokenHelp();
    saveParamsSearchFlight({});
  }, []);

  return (
    <div className='h-screen bg-indigo-100 p-1 md:p-10 flex items-center justify-center'>
